...
Panda and Redinho explore the use of Spotify high-level features applied to Music Emotion Recognition (MER).
...
Panda and Redinho explore the use of Spotify features applied to Music Emotion Recognition (MER).
In particular, they 
...
A tag can refer to any aspect that users consider 

For nearly two decades, many music aficionados have contributed their own unique, personal 

For nearly two decades, the Last.fm community has been active, contributing 
...
Spotify, one of the leaders in the music streaming industry, provides information about the tracks in their catalog via the Spotify API.
...
For us, the first step to construct the dataset was 
