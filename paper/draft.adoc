...
Introduce relevant studies about MIR.
...
We have trained a group of well-known machine learning models to predict an audio feature, given the set of tags for a particular track.
