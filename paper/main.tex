...
\begin{table}[h!]
      ...
      Tree      & 10000 tags                          &\textbf{0.148}    & 0.250           &\textbf{0.181}  & 0.235           &\textbf{0.290}  \\
      Tree      & 100 tokens D                        & 0.274            & 0.274           & 0.212          & 0.256           & 0.330          \\
      Tree      & 1000 tokens D                       & 0.173            & 0.278           & 0.215          & \textbf{0.220}  & 0.339          \\
      ...
      Tree      & 1000 tokens TC                      & 0.174            & 0.282           & 0.215          & \textbf{0.220}  & 0.344          \\
...
The Spotify feature that the models had less trouble estimating was the danceability.
The instrumentalness, however, was the feature that presented the highest deviations.
The GTP-2 model was the best model to predict the danceability, with a \num{0.145} RMSE.
The Boosted tree was the best model to predict the instrumentalness, with a RMSE value of \num{0.29}.

In general, the three models performed similarly, with GPT-2 achieving the slightly better results in danceability and acousticness. The Boosted Tree regressor was the best model to predict energy, valence, and instrumentalness.
...
The Bayesian regressor was a bit more sensitive to changes in tag formating.
